...
#to update new data for cell
def update_excel_data(filePath, searchTerm, colName, new_value):
    book = openpyxl.load_workbook(filePath)
    sheet = book.active
    Dict = {}

    for i in range(1, sheet.max_column + 1): #1 to end of the column cell
...
#new_value=990
#colname=price
#searchterm=apple using this loop

file_path = "C:\\Users\\Adil\\Downloads\\download (10).xlsx"
fruit_name = "Apple"
newValue = "990"
